...
class CustomSignupDialog extends StatefulWidget {
  const CustomSignupDialog({Key? key, required this.pressed}) : super(key: key);
  final VoidCallback pressed;
  @override
  State<CustomSignupDialog> createState() => _CustomSignupDialogState();
}

class _CustomSignupDialogState extends State<CustomSignupDialog> {
  bool hidden = true;
  @override
